...
export const Skills: SkillDef[] = [
  {
     ...
     * 1.45 下来是 49，只占半屏的三成二；配合张角收窄（见 heroes.ts 的 attackArc），
     * 扇面面积是原来的一半。还是一招扫开身前一片，但两侧重新有了空档。
     */
    reach: 1.45,
    arc: null,
    duration: 0,
  ...
  },
  {
     ...
     *
     * 3.3 下来是 53，仍然是全场最长（横扫 49），但只长一点点。"最远"还是他的，
     * 只是不再把别人读成短手短脚。跟着横扫一起往下调是故意的：只砍一边的话，
     * 上一轮刚调平的那个差距当场又裂回去了。
     */
    reach: 3.3,
    arc: 0.9,
