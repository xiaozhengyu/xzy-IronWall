...
export const Skills: SkillDef[] = [
  {
    ...
    arc: null,
    duration: 0,
    // 原来给 1，理由是"横扫就是基础那一下"。但玩家看到的不是这个理由，是一把武器抡过一排人、
    // 人整齐倒下、地上只落两片东西 —— 读作把他们推倒了，不是劈碎了。破空那一发之所以有破坏感，
    // 靠的正是这一档：血加甲片、量足够多。既然横扫也是一个占着自动攻击槽的**技能**，它就该和
    // 破空同一档。代价是扣血数字也跟着进技能区间（见 rollDamage），而那本来就是占位数。
    power: 2,
    cooldown: 0,
    finishRing: 0,
  },
